                    ...
                    @if($appointment->status == "Pending")
                        <tbody style="background-color: white">
                            <tr style="text-align: center">
                                ...
                                <td><a href="{{route('lectures.update', $appointment->id)}}" class="btn btn-dark btn-sm">Yes</a>
                                    <a href="{{route('lectures.cancel', $appointment->id)}}" class="btn btn-dark btn-sm">No</a></td>
                            </tr>
                        </tbody>
                    @endif
                @endforeach
                    ...
                    @if($appointment->status == "Approved")
                        <tbody style="background-color: white">
                            <tr style="text-align: center">
                                ...
                                <td>{{$appointment->remarks}}</td>
                                <td>{{$appointment->status}}</td>
                                <td><a href="{{route('lectures.cancel', $appointment->id)}}" class="btn btn-dark btn-sm">Cancel</a></td>
                            </tr>
                        </tbody>
                    @endif
                @endforeach
